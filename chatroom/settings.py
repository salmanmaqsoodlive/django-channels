...
SECRET_KEY = "django-insecure-!bw4nzvkfi6zjtu1*j6kq#0f^l$^dd_b8l5jvtx9uf=@1y^c4y"
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:3000", 
    "https://react-chat-app-mu-eight.vercel.app",
]
...
MEDIA_URL = "/media/"
MEDIA_ROOT = os.path.join(BASE_DIR, "chat_files")
